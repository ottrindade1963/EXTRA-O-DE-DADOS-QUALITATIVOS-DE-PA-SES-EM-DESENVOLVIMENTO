...
# ─── Caminhos ───
# Os ficheiros estão em subpastas: dados_preparados/{dataset}/
BASE_DIR = os.path.dirname(os.path.abspath(__file__))
DATA_DIR = os.path.join(BASE_DIR, "dados_preparados")
OUTPUT_DIR = os.path.join(BASE_DIR, "resultados_modelos")

# ─── Datasets (estrutura de pastas: dados_preparados/{dataset}/) ───
DATASETS = {
    "inner": os.path.join(DATA_DIR, "inner"),
    "left": os.path.join(DATA_DIR, "left"),
    "outer": os.path.join(DATA_DIR, "outer"),
}
